        ...
        <div>
            <form className='flex flex-col gap-2 border-2 p-2 mt-4 rounded-md'onSubmit={(e) => {handleSubmit(e); props.closeModal()}}>
                <div className='flex flex-col'>
                    <label>School</label>
                    <input type='text' name='school' onChange={handleChange} className='border-2 rounded-md h-8'></input>
                </div>
                <div className='flex flex-col'>
                ...
                <div className='flex flex-col'>
                    ...
                    <select name='degree' id='degree' onChange={handleChange} className='border-2 rounded-md h-8 text-sm'>
                        <option>None</option>
                ...
                <div className = 'flex flex-col'>
                    ...
                    <input type='text' name='major' onChange={handleChange} className='border-2 rounded-md h-8'></input>
                </div>
                <div className='flex flex-col'>
                ...
                <div className='flex gap-2'>
                    ...
                    <button onClick={props.closeModal} type='button' className='border-2 rounded-md text-[#7B9ACC] py-2 px-2'>Cancel</button>
                </div>
            </form>
        </div>
    )
